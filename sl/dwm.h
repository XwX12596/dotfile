...
static const char *fonts[]          = { "Hack:size=12", "Noto Sans CJK SC:size=12" };
...
static const char *scrotcmd[]  = { "scrot", "-s", "/home/xwx/Media/snapshot/%Y%m%d%H%M%S.png", NULL };
